...
public class MainNotificationResponse {
    ...
    @Expose
    private List<SubNotificationResultResponse> result;
    ...
    public List<SubNotificationResultResponse> getResult() {
        return result;
    }

    public void setResult(List<SubNotificationResultResponse> result) {
        this.result = result;
    }
