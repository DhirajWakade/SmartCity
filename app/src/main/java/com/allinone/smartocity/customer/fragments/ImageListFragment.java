...
package com.allinone.smartocity.customer.fragments;
...
public class ImageListFragment extends Fragment {
    ...
    private static MainCustomerDashboardActivity mActivity;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mActivity = (MainCustomerDashboardActivity) getActivity();
    }
