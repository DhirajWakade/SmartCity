...
public class UpdateKiranaProductActivity extends AppCompatActivity implements View.OnClickListener, RestCalllback, AdapterView.OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_kirana_product);
    ...
    private void setProductSizeList(BusinessTypeModel typeModel) {
        ...
        if (businessListResponse.getBusinessTypes().getIsMultiSelection().equals("YES")) {
            ...
            productSizeMultipleAdapter = new ProductSizeMultipleAdapter(UpdateKiranaProductActivity.this, 0,
                    product_size_list);
            ...
            productSizeSingleAdapter = new ProductSizeSingleAdapter(UpdateKiranaProductActivity.this, 0,
                    product_size_list);
    ...
    private void setProductTaxRateList(List<TaxRatesItemModel> rateList) {
        ...
        pproductTaxRateAdapter = new ProductTaxRateAdapter(UpdateKiranaProductActivity.this, 0, product_tax_rate_list);
    ...
    private void setProductTypeList(BusinessTypeModel typeModel) {
        ...
        categoryAdapter = new ProductCategoryAdapter(UpdateKiranaProductActivity.this, 0,
                product_type_list);
   ...
   /* private void getProductCategoryList() {
        if (
                InternetConnection.checkConnection(UpdateKiranaProductActivity.this)) {
            categoriesList();
        } else {
            Toast.makeText(UpdateKiranaProductActivity.this, getResources().getString(R.string.internetconnectio), Toast.LENGTH_SHORT).show();
        }
    }*/
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_submit_product:
                if (valid4()) {
                    if (InternetConnection.checkConnection(UpdateKiranaProductActivity.this)) {
                        uploadImage();
                    } else {
                        Toast.makeText(UpdateKiranaProductActivity.this, getResources().getString(R.string.internetconnectio), Toast.LENGTH_SHORT).show();
                    }
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(UpdateKiranaProductActivity.this)
                .setMessage(message)
    ...
    private void screen2() {
        ...
        if (businessListResponse.getBusinessTypes().getIsMultiSelection().equals("YES")) {
            ...
            for (int i = 0; i < selected_product_size_id_model.size(); i++) {
                ...
                ed = new EditText(UpdateKiranaProductActivity.this);
                allEds.add(ed);
...
/*    public void onAddFieldBulletPoint(View v) {
    ...
    private void addProduct() {
        ...
        try {
            ...
            productMaster.put("productId", productTypeModel.getProductCatName());
            ...
            JSONArray jsonSubImageA = new JSONArray();
            ...
            productMaster.put("productImageUrl", uploadedImageName);
        ...
        walletDeductDetails.enqueue(new RestProcess<String>(UpdateKiranaProductActivity.this, UpdateKiranaProductActivity.this, ADDPRODUCT, true));
    ...
    private void categoriesList() {
        ...
        productDetails.enqueue(new RestProcess<String>(UpdateKiranaProductActivity.this, UpdateKiranaProductActivity.this, GETPROSUCTCATEGORIESLIST, true));
    }
    ...
    private void ProductSizeList() {
        ...
        productsizeDetails.enqueue(new RestProcess<String>(UpdateKiranaProductActivity.this, UpdateKiranaProductActivity.this, PRODUCT_SIZE, true));
    }
    ...
    private void uploadImage() {
        ...
        productDetails.enqueue(new RestProcess<String>(UpdateKiranaProductActivity.this, UpdateKiranaProductActivity.this, GETPROSUCTUPLOADIMAGE, true));
    }
    ...
    private void uploadSubImage() {
        ...
        productDetails.enqueue(new RestProcess<String>(UpdateKiranaProductActivity.this, UpdateKiranaProductActivity.this, GETPROSUCTUPLOADSUBIMAGE, true));
    }
    ...
    private boolean valid1() {
        ...
        if (productTypeModel == null) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please select type", Toast.LENGTH_SHORT).show();
            return false;
        }
        if (product_title.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter product  title", Toast.LENGTH_SHORT).show();
            return false;
        }
        if (product_brand.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter product brand", Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (businessListResponse.getBusinessTypes().getIsMultiSelection().equals("YES")) {
            ...
            if (selected_product_size_id_model.size() == 0) {
                Toast.makeText(UpdateKiranaProductActivity.this, "Please select product size at list one", Toast.LENGTH_SHORT).show();
                return false;
            }
        } else {
            if (productSizeModel == null) {
                Toast.makeText(UpdateKiranaProductActivity.this, "Please select product size", Toast.LENGTH_SHORT).show();
                return false;
            }
        }
        return true;
    ...
    private boolean valid4() {
        if (mPhotoFile == null) {
            ...
            Toast.makeText(UpdateKiranaProductActivity.this, "Please select main_business product image", Toast.LENGTH_SHORT).show();
            return false;
        ...
        if (mPhotoFile1 == null) {
            ...
            Toast.makeText(UpdateKiranaProductActivity.this, "Please select Sub image 1", Toast.LENGTH_SHORT).show();
            return false;
        ...
        if (mPhotoFile2 == null) {
            ...
            Toast.makeText(UpdateKiranaProductActivity.this, "Please select Sub image 2", Toast.LENGTH_SHORT).show();
            return false;
        ...
        if (mPhotoFile3 == null) {
            ...
            Toast.makeText(UpdateKiranaProductActivity.this, "Please select Sub image 3", Toast.LENGTH_SHORT).show();
            return false;
    ...
    private boolean valid2() {
       ...
       /* if (product_sdler_sku.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter product sku", Toast.LENGTH_SHORT).show();
            return false;
        }*/


        if (productTaxRateModel == null) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please select product tax rate", Toast.LENGTH_SHORT).show();
            return false;
        }

        if (product_actual_price.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter product actual price", Toast.LENGTH_SHORT).show();
            return false;
        }
        if (product_final_price.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter product final price", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private boolean valid3() {
       ...
       /* if (productSubCategory == null) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please select Sub Category", Toast.LENGTH_SHORT).show();
            return false;
        }*/


        if (product_available_quantity.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter product available quantity", Toast.LENGTH_SHORT).show();
            return false;
        }


        if (product_max_order_quantity.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter product max order", Toast.LENGTH_SHORT).show();
            return false;
        }

        if (encluse_material.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter material", Toast.LENGTH_SHORT).show();
            return false;
        }

        if (product_description.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter product description", Toast.LENGTH_SHORT).show();
            return false;
        }

        if (keyword.equals("")) {
            Toast.makeText(UpdateKiranaProductActivity.this, "Please enter keyword", Toast.LENGTH_SHORT).show();
            return false;
        }
    ...
    private void selectImage(final int requestTakePhoto, final int requestGalleryPhoto) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(UpdateKiranaProductActivity.this);
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                ...
                case 1:
                    ...
                    Glide.with(UpdateKiranaProductActivity.this)
                            .load(mPhotoFile)
            ...
            case GETPROSUCTUPLOADIMAGE:
                try {
                    ...
                    if (jsonObject.getString("status").equals("1")) {
                        ...
                        Toast.makeText(UpdateKiranaProductActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        uploadSubImage();
                    } else {
                        Toast.makeText(UpdateKiranaProductActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                    ...
                    if (response.getStatus().equals("1")) {
                        ...
                        if (response.getResult() != null) {
                            if (response.getResult().size() > 0) {
                                ...
                                subCategoryAdapter = new ProductSubCategoryAdapter(UpdateKiranaProductActivity.this, 0,
                                        sub_category_list);
                        ...
                        Toast.makeText(UpdateKiranaProductActivity.this, response.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
