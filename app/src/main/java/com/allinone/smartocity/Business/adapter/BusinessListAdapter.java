...
public class BusinessListAdapter extends RecyclerView.Adapter<BusinessListAdapter.MyViewHolder> {
    ...
    public BusinessListAdapter(Context mCtx, List<BusinessListResponse> productList, OnitemClick clic) {
        this.mCtx = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.btn_edit_business.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView btn_add_product,btn_edit_business;
        ...
        public MyViewHolder(View itemView) {
            ...
            btn_edit_business = itemView.findViewById(R.id.btn_edit_business);
