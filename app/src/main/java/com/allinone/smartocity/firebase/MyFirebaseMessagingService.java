package com.allinone.smartocity.firebase;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageBody) {
        ...
        Intent intent;
        if (1 == 1) {
            MainCustomerDashboardActivity.notificationCount++;
            NotificationCountSetClass.setNotifyCount(MainCustomerDashboardActivity.notificationCount);
            intent = new Intent(this, MainCustomerDashboardActivity.class);

        } else {
            MainBusinessActivity.notificationCount++;
            NotificationCountSetClass.setNotifyCount(MainCustomerDashboardActivity.notificationCount);
            intent = new Intent(this, MainBusinessActivity.class);
        }
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.smartcity)
